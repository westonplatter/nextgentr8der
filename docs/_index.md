...
| [spec-remove-order-execution.md](spec-remove-order-execution.md)                   | orders, execution, safety, decommission, architecture | Spec for removing all order submission/queue paths while preserving read-only monitoring and historical audit surfaces  |
